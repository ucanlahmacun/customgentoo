...
# air.sh {
	...
	TMUX_POWERLINE_SEG_AIR_OPEN_WEATHER_API_KEY="948f642c5349706800235a8a1df822cb"
# }
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/dede/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/mail/dede"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/dede/.mailcheckrc"
# }
